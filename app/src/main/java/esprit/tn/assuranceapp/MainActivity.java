...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewTestAcc = (TextView)findViewById(R.id.textViewGetAcc);
        ...
        textViewTestAcc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if ( v== textViewTestAcc){

                    startActivity(new Intent(MainActivity.this,TestAccounts.class ));
                }
            }
        });
    }
